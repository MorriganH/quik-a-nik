import { ADD_TO_CART, GENERATE_PRODUCTS, TOGGLE_MODAL } from "./actions";
...
const initialState = {
  ...
  products: [
    ...
    },
    {
      ...
      price_cents: 5000,
      description:
        "4 Frozen Hambuger Patties, 4 Hot Dogs, 4 Hamburger Buns, 4 Hot Dog Buns, 1 Set of Tongs",
      is_basket: true,
      portions: 8,
      is_deluxe: false,
    ...
    },
    {
      ...
      price_cents: 12000,
      description:
        "8 Frozen Hambuger Patties, 8 Hot Dogs, 8 Hamburger Buns, 8 Hot Dog Buns, 1 Set of Tongs, 6 Pack of Beer, 6 Pack of Wine Coolers",
      is_basket: true,
      portions: 4,
      is_deluxe: true,
  ...
  isLoading: true,
  showModal: false, //Default state for Stripe modal
};
...
const reducer = function (state = initialState, action) {
  switch (action.type) {
    ...
    case TOGGLE_MODAL:
      return {
        ...state,
        showModal: !state.showModal, // Toggle the value of showModal
      };
